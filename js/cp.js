...
const SBC_DATA = {
    ...
    ball_screw: [
        ...
        { name: "DHDS-A", img: "../images/dhds-a.jpg" },
        { name: "DJC-CG", img: "../images/djc-cg.jpg" },
        { name: "DJCS-CD", img: "../images/djcs-cd.jpg" },
        { name: "DRJT-A", img: "../images/drjt-a.jpg" },
        { name: "DRJT-S", img: "../images/drjt-s.jpg" }
    ]
};
