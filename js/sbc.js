...
const SBC_DATA = {
    lm_guide: [
        { name: "SBI-FL/FLL [HSR-A(B)/LA(B) 대응품]", img: "../images/SBI-FL.FLL.jpg" },
        { name: "SBI-SL/SLL [HSR-R/LR 대용품]", img: "../images/SBI-SL.SLL.jpg" },
        { name: "SBI-HL/HLL [SR-W 대용품]", img: "../images/SBI-HL.HLL.jpg" },
        { name: "SBI-CL/CLL [SR-V 대용품]", img: "../images/SBI-CL.CLL.jpg" },
        { name: "SBI-FV [SR-SB 대용품]", img: "../images/SBI-FV.jpg" },
        { name: "SBI-SV [SR-V 대용품]", img: "../images/SBI-SV.jpg" },
        { name: "SPG / SPS [SHS/SSR 대응품]", img: "../images/SPG.SPS.jpg" },
        { name: "SBM-L/W [RSR 대응품]", img: "../images/SBM-L.W.jpg" },
        { name: "SBG-FL/FLL [HSR-A(B) 대응품]", img: "../images/SBI-FL.FLL.jpg" },
        { name: "SBG-SL/SLL [HSR-R 대응품]", img: "../images/SBI-SL.SLL.jpg" },
        { name: "SBS-SL / SLL [SR-W 대응품]", img: "../images/SBI-HL.HLL.jpg" },
        { name: "SBS-FV [ SR-SB 대응품 ]", img: "../images/SBI-FV.jpg" },
        { name: "SBS-SV [SR-V 대응품]", img: "../images/SBI-SV.jpg" },
        { name: "SBM/SBML[미니츄어]", img: "../images/SBM.SMBL.jpg" },
        { name: "SBM/SBML[광폭형 미니츄어]", img: "../images/SBM.SMBL.jpg" }
    ],
    ball_screw: [
        { name: "SBC 전조 볼스크류 SLK", img: "../images/slk.jpg" },
        { name: "SBC 전조 볼스크류 STK", img: "../images/stk.jpg" }
    ]
};
